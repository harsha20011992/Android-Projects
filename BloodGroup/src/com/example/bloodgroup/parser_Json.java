...
public class parser_Json extends AsyncTask<String, String, JSONObject>{
	...
	public parser_Json(Context cont){
		context = cont;
	}
	...
	public String Address1 = "", Address2 = "", City = "", State = "", Country = "", County = "", PIN = "";
	   ...
	   // Not only params but also the JSON object that must be appended to the url must be sent while sending data to the server
		@Override
